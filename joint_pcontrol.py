...
def _pdo_update_loop():
    ...
    try:
        while 1:
            ...
            if (index<=80000):
                joint_pdo.TargetPosition = int(100000*math.sin((2*math.pi)/(80000/6)*index))
            else: 
                joint_pdo.TargetPosition = 0
            ...
            print('position',joint_pdo.PositionActualValue,
                  'target position', joint_pdo.TargetPosition)
