...
def _pdo_update_loop():
    ...
    # Joint_Position_end = [0,-10000,0,0,0,-10000]
    Joint_Position_end = [0,0,0,0,0,0]
    ...
    try:
        while 1:
            ...
            if (index<=task_span):
                ...
                # Joint_Position_target = [int(50000*math.sin((2*math.pi)/(task_span/3)*index) + Joint_Position_start[0]),
                #                          int(50000*math.sin((2*math.pi)/(task_span/3)*index) + Joint_Position_start[1]),
                #                          int(50000*math.sin((2*math.pi)/(task_span/3)*index) + Joint_Position_start[2]),
                #                          int(50000*math.sin((2*math.pi)/(task_span/3)*index) + Joint_Position_start[3]),
                #                          int(50000*math.sin((2*math.pi)/(task_span/3)*index) + Joint_Position_start[4]),
                #                          int(50000*math.sin((2*math.pi)/(task_span/3)*index) + Joint_Position_start[5])]
                ...
                # Joint_Position_target = [int(0 + Joint_Position_start[0]),
                #                          int(0 + Joint_Position_start[1]),
                #                          int(0 + Joint_Position_start[2]),
                #                          int(0 + Joint_Position_start[3]),
                #                          int(0 + Joint_Position_start[4]),
                #                          int(0 + Joint_Position_start[5])]
